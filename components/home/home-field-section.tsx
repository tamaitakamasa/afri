...
export default function HomeFieldSection() {
  return (
    <>
      <div className="bg-background aspect-square w-40">hoge</div>
      <section className="bg-background relative w-full pt-40">
        <div className="z-1 h-60 md:h-full md:w-full relative md:absolute md:inset-0">
        <Image
          src={map}
          fill
          alt="地図"
        ...
        <div className="md:px-30 bg-background py-30 relative z-10 ml-auto flex flex-col gap-20 md:w-7/12">

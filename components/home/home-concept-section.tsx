...
function ConceptContent({ children }: { children: React.ReactNode }) {
  return (
    <div className="md:w-[36rem] md:my-20">
      <div className="flex flex-col gap-8 md:gap-10 text-sm leading-[1.8] md:leading-[2] md:text-base">
        {children}
      </div>
    </div>
  );
...
export default function HomeConceptSection() {
  return (
    ...
    >
      ...
      <div
        id="concept1"
        className="md:gap-18 relative mt-10 flex flex-col gap-10 md:mt-10 md:flex-row"
      >
        <div className="relative flex-1">
          <h3 className="sticky top-0 text-base font-medium md:py-20 md:text-xl">
            「美味しい」の解像度をあげる
          </h3>
        </div>
        <ConceptContent>
